...
if (!ModuleManager::isModuleInstalled('airecogn') || !Loader::includeModule('airecogn'))
{
    throw new RuntimeException('Module airecogn is not installed');
}

$eventManager = EventManager::getInstance();
$handlers = $eventManager->findEventHandlers('voximplant', 'onCallEnd', ['airecogn']);
