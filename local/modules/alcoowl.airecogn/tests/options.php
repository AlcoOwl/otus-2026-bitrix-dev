...
$enabled = Option::get('alcoowl.airecogn', 'enabled', 'Y');
$loggingEnabled = Option::get('alcoowl.airecogn', 'logging_enabled', 'Y');
$logLevel = Option::get('alcoowl.airecogn', 'log_level', 'info');
$logTailSize = (int)Option::get('alcoowl.airecogn', 'log_tail_size', '200');
