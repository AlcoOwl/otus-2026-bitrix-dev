...
?>
    ...
    <section class="container-fluid">
        ...
        <div class="mb-3">Репозиторий: <a href="https://github.com/AlcoOwl/otus-2026-bitrix-dev">AlcoOwl</a></div>
        <ul class="item-list">
            <li>
                <h2 class="item done">
            ...
            <li>
                <h2 class="item done"><a href="homework5">ДЗ #5: Разработка собственного компонента</a>
                    <i class="icon"></i>
                </h2>
            </li>
            <li>
            ...
            <li>
                <h2 class="item clock"><a href="homework7">ДЗ #7: Создание собственного типа поля для элементов инфоблока</a>
                    <i class="icon"></i>
                </h2>
            </li>
            <li>
